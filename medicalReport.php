...
<html>
   <head>
      <title>Employee Health Details</title>
      <meta charset="UTF-8">
...
<!----list  the link related to admin action (vertical navbar) ------>
            <div class="col-sm-3 margin">
              <ul class="test">
                <li id="l1" class="active"><a href="heartRateReport.php">Heart Rate</a></li>
                <li id="l2"><a href="temperatureReport.php">Temperature</a></li>
              </ul>
             </div>
